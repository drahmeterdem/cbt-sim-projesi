...
<div id="login-screen" class="screen flex items-center justify-center">
    <div class="w-full max-w-md mx-auto bg-white/50 backdrop-blur-lg p-10 rounded-2xl shadow-xl">
        <div id="login-view">
            <h2 class="text-gray-900 tracking-tight text-3xl font-bold text-center">Giriş Yap</h2>
            <p class="text-center text-gray-600 mt-2">Öğrenci veya öğretmen olarak giriş yapın.</p>
